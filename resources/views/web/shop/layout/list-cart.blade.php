            ...
            @if (Session::has('Cart') != null)
                @foreach (Session::get('Cart')->products as $item)
                    <tr>
                        ...
                        <td class="p-price first-row">{{ number_format($item['productInfo']->price) }} đ
                        </td>
    ...
    <div class="col-lg-4 offset-lg-8">
        <div class="proceed-checkout">
            <ul>
                ...
                <li class="cart-total">Tổng tiền: <span>{{ number_format (Session::get('Cart')->totalPrice)}} VND</span></li>
            </ul>
